...
const VisMenu = MenuBuilder.extend({
  ...
  render: function() {
    ...
    this.addNode("Reset", () => {
      ...
      this.g.vis.set("markers", true);
      this.g.vis.set("metacell", false);
      this.g.vis.set("conserv", false);
      this.g.vis.set("labelId", false);
      this.g.vis.set("labelName", true);
      this.g.vis.set("labelCheckbox", false);
      this.g.vis.set("seqlogo", true);
      this.g.vis.set("gapHeader", false);
      this.g.vis.set("leftHeader", true);
      this.g.vis.set("metaGaps", false);
      this.g.vis.set("metaIdentity", false);
      return this.g.vis.set("metaLinks", false);
    });
