...
var VisMenu = _menubuilder2.default.extend({
  ...
  render: function render() {
    ...
    this.addNode("Reset", function () {
      ...
      _this.g.vis.set("markers", true);
      _this.g.vis.set("metacell", false);
      _this.g.vis.set("conserv", false);
      _this.g.vis.set("labelId", false);
      _this.g.vis.set("labelName", true);
      _this.g.vis.set("labelCheckbox", false);
      _this.g.vis.set("seqlogo", true);
      _this.g.vis.set("gapHeader", false);
      _this.g.vis.set("leftHeader", true);
      _this.g.vis.set("metaGaps", false);
      _this.g.vis.set("metaIdentity", false);
      return _this.g.vis.set("metaLinks", false);
    });
